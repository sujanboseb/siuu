    ...
    if conversation_state:
        ...
        try:
            ...
            if intent == 'Greetings':
              ...
              greeting_message = (
                  "1.This number is for meeting and cab management.%0a"
                  "2.You can check  your meetings from the past dates.%0a "
                  "3.Please provide the ** meeting date ** in **'dd/mm/yyyy'** format and the ** time **  in **'hh:mm AM/PM'** format.%0a"
